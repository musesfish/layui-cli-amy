...
function style_html(t, e, i, n) {
  function l() {
    return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
      ...
      in_array: function in_array(t, e) {
      ...
      if ("/" === l.charAt(l.length - 2) || this.Utils.in_array(a, this.Utils.single_token)) this.tag_type = "SINGLE";else if ("script" === a) this.record_tag(a), this.tag_type = "SCRIPT";else if ("style" === a) this.record_tag(a), this.tag_type = "STYLE";else if ("!" === a.charAt(0)) {
        if (-1 !== a.indexOf("[if")) {
          if (-1 != l.indexOf("!IE")) {
      ...
      this.print_newline = function (t, e) {
        if (this.line_char_count = 0, e && e.length) {
          if (!t) for (; this.Utils.in_array(e[e.length - 1], this.Utils.whitespace);) {
            e.pop();
          }
          e.push("\n");
...
layui.define(["layer", "form", "code"], function (t) {
  ...
  s.prototype.set = function (t) {
    ...
    return a.ie && a.ie < 8 ? s.removeClass("layui-hide").addClass("layui-show") : (u[0] && u.remove(), r.call(n, m, s[0], f), s.addClass("layui-hide").after(m), layui.use(["colorpicker", "jquery"], function () {
      for (var t = layui.colorpicker, e = (layui.jquery, 0); e <= n.index; e++) {
        t.render({
          elem: "#layBkColor_" + e,
          predefine: !0,
  ...
  var r = function r(t, e, n) {
    ...
    r.on("keydown", function (t) {
      ...
      if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items) {
        for (var c = 0, u = e.originalEvent.clipboardData.items.length; c < u; c++) {
          ...
          if ("file" === h.kind) {
            var y = h.getAsFile(),
                g = new FormData(); // g.append("file", y);
            ...
            if (i.ajax({
              ...
              success: function success(t) {
                ...
                0 != t.code && 2 != t.code || (x = t.files[0].saveUrl, o.uploadImage.done(t));
              },
    ...
    var a = t.document,
        ...
        layui.use("upload", function (o) {
          ...
          "" == r.url && n.msg("上传接口配置错误！"), o.render({
            ...
            elem: i(a).find("input")[0],
              ...
              100 == i.ret ? ( // 0 == i.code ? (i.data = i.data || {},
              h.call(t, "img", {
                // src: i.data.src,
          ...
          success: function success(t, e) {
            layui.use("upload", function () {
              ...
              e.render({
                ...
                done: function done(e, o, s) {
                  0 == e.code ? (e.data = e.data || {}, // i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src),
                  i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.files[0].visitUrl), a.done(e)) : 2 == e.code ? (e.data = e.data || {}, // i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src),
                  i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.files[0].visitUrl), a.done(e)) : n.msg(e.msg || "上传失败"), t.find("#imgsPrev img").on("click", function () {
                    var t = this.src,
                    ...
                    n.confirm("是否删除该图片?", {
                      ...
                      // i("#imgsPrev img[data-index=" + e + "]")[0].remove()),
                      // n.close(a)
                      i("#imgsPrev img[data-index=" + e + "]")[0].remove(), n.close(a);
                    });
                  });
                }
              });
      ...
      image_alt: function image_alt(e) {
        console.log('smy3');
        n.open({
          type: 1,
          id: "fly-jie-image-upload",
          ...
          success: function success(t, e) {
            layui.use("upload", function (e) {
              ...
              "" == s.url && n.msg("上传接口配置错误！"), e.render({
                ...
                done: function done(t, e, l) {
                  if (n.close(i), // 0 == t.code)
                  100 == t.ret) // t.data = t.data || {},
                    // o.val(t.data.src),
                    o.val(t.files[0] && t.files[0].visitUrl), // a.val(t.data.name),
                    a.val(t.files[0].orgName), s.done(t); // else if (2 == t.code)
                  else if (100 == t.ret) var r = n.open({
                      type: 1,
                      anim: 2,
                      icon: 5,
                      title: "提示",
                      ...
                      yes: function yes() {
                        ...
                        // o.val(t.data.src),
                        o.val(t.files[0] && t.files[0].visitUrl), // a.val(t.data.name),
                        a.val(t.files[0].orgName), n.close(r);
                      }
            ...
            layui.use("upload", function (e) {
              ...
              "" == d.url && n.msg("视频上传接口配置错误！"), e.render({
                ...
                before: function before(t) {
                  ...
                  if (n.close(i), 100 == t.ret) // 0 == t.code)
                    // t.data = t.data || {},
                    // s.val(t.data.src),
                    s.val(t.files[0] && t.files[0].visitUrl), r.done(t); // else if (2 == t.code)
                  else if (100 == t.ret) var a = n.open({
                      type: 1,
                      anim: 2,
                      icon: 5,
                      title: "提示",
                      ...
                      yes: function yes() {
                        // t.data = t.data || {},
                        // s.val(t.data.src),
                        s.val(t.files[0] && t.files[0].visitUrl), n.close(a);
                      }
                    });else n.msg(t.msg || "上传失败");
                }
              }), e.render({
                ...
                before: function before(t) {
                  ...
                  100 == t.ret) // t.data = t.data || {},
                    // o.val(t.data.src),
                    o.val(t.files[0] && t.files[0].visitUrl), d.done(t);else if (100 == t.ret) // else if (2 == t.code)
                    var a = n.open({
                      type: 1,
                      anim: 2,
                      icon: 5,
                      ...
                      yes: function yes() {
                        // t.data = t.data || {},
                        // o.val(t.data.src),
                        o.val(t.files[0] && t.files[0].visitUrl), n.close(a);
                      }
                    });else n.msg(t.msg || "上传失败");
                }
              });
          ...
          success: function success(a, o) {
            layui.use("upload", function () {
              ...
              s.render({
                ...
                before: function before(t) {
                  t.preview(function (t, e, n) {
                    -1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.orgName + '" >' + e.orgName + "</a>&nbsp;"); // -1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.name + '" >' + e.name + "</a>&nbsp;")
                  });
                },
                allDone: function allDone() {
                ...
                done: function done(t, e, o) {
                  // 0 == t.code ? (
                  100 == t.ret ? ( // t.data = t.data || {},
                  // i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src),
                  i('#filesPrev a[data-index="' + e + '"]').attr("href", t.files[0] && t.files[0].visitUrl), // r.done(t)) : 2 == t.code ? (n.msg(t.msg || "上传失败"),
                  r.done(t)) : 100 == t.ret ? (n.msg(t.msg || "上传失败"), // t.data = t.data || {},
                  // i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src),
                  i('#filesPrev a[data-index="' + e + '"]').attr("href", t.files[0] && t.files[0].visitUrl), r.done(t)) : n.msg(t.msg || "上传失败"), a.find("#filesPrev a").on("click", function () {
      ...
      fontFomatt: function fontFomatt(t) {
        var e = l.fontFomatt || {
      ...
      customlink: function customlink(e) {
        var n = m(e),
            a = i(n).parent();
        x.call(s, {
    ...
    var f = null,
      ...
      var e = l.rightBtn || {
        type: "layBtn",
        customEvent: function customEvent(t, e) {}
      };
              ...
              success: function success(t, e) {
                ...
                return "" == i.url && n.msg("图片上传接口配置错误！"), layui.use("upload", function (e) {
                  ...
                  e = layui.upload, e.render({
                    ...
                    done: function done(t, e, i) {
                      if (n.close(l), // 0 == t.code)
                      100 == t.ret) // t.data = t.data || {},
                        // o.val(t.data.src),
                        o.val(t.files[0] && t.files[0].visitUrl), // a.val(t.data.name),
                        a.val(t.files[0].orgName); // else if (2 == t.code)
                      else if (100 == t.ret) var s = n.open({
                          type: 1,
                          anim: 2,
                          icon: 5,
                          title: "提示",
                ...
                layui.use("upload", function (e) {
                  ...
                  "" == r.url && n.msg("图片上传接口配置错误！"), "" == d.url && n.msg("视频上传接口配置错误！"), e.render({
                    ...
                    before: function before(t) {
                      ...
                      100 == t.ret) // t.data = t.data || {},
                        // o.val(t.data.src),
                        o.val(t.files[0] && t.files[0].visitUrl), r.done(t); // else if (2 == t.code)
                      else if (100 == t.ret) var a = n.open({
                          type: 1,
                          anim: 2,
                          icon: 5,
                    ...
                    before: function before(t) {
                      ...
                      100 == t.ret) // t.data = t.data || {},
                        // a.val(t.data.src),
                        a.val(t.files[0] && t.files[0].visitUrl), d.done(t); // else if (2 == t.code)
                      else if (100 == t.ret) var o = n.open({
                          type: 1,
                          anim: 2,
                          icon: 5,
                          title: "提示",
                          ...
                          yes: function yes() {
                            // t.data = t.data || {},
                            // a.val(t.data.src),
                            a.val(t.files[0] && t.files[0].visitUrl), n.close(o);
                          }
                        });else n.msg(t.msg || "上传失败");
                    }
                  });
    ...
    var o = e.dmode,
      ...
      btn: ["确定", "取消"],
      btnAlign: "c",
      yes: function yes(t, e) {
        i("#layedit-link-yes").click();
      },
      btn1: function btn1(t, e) {
