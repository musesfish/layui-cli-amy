            ...
            if (!d) {
              var b = function b() {
                ...
                n.removeClass(t + 'ed ' + t + 'up'), m.blur(), v = null, e || $(m.val(), function (e) {
                  e && (c = k.find('.' + r).html(), m && k.find('.' + r).prop('lay-value') && m.val(c));
                });
              },
                  w = function w() {
              ...
              f && m.on('keyup', function (e) {
                ...
                var e = i(this),
                    t = e.attr('lay-value'),
                    a = y.attr('lay-filter');
                return !e.hasClass(o) && (e.hasClass('layui-select-tips') ? m.val('') : (m.val(e.text()), e.addClass(r)), e.siblings().removeClass(r), y.val(t).removeClass('layui-form-danger').trigger('change'), layui.event.call(this, 'form', 'select(' + a + ')', {
                  elem: y[0],
                  value: t,
                  othis: n
                }), C(!0), !1);
