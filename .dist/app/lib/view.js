...
;layui.define(["laytpl", "layer",], function (e) {
    ...
    i.loading = function (e) {
        e.append(this.elemLoad = t('<i class="layui-anim layui-anim-rotate layui-anim-loop layadmin-loading"></i>'))
    }, i.removeLoad = function () {
        this.elemLoad && this.elemLoad.remove()
    }, i.exit = function () {
        layui.store.delete(layui.setter.tableName),
        ...
        var n = this; 
        var d = layui.menu.getMenu(); 
        
        if (d.indexOf(e)>=0 || d.indexOf(e.replace(/\/index$/, ''))>=0) e = e; 
        else {
            location.hash = '#';
            return false;
        }
