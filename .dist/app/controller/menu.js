...
layui.define(function (e) {
  ...
  */
  ...
  var menu = ['layout', 'index', 'user/login', 'brower/support', 'system/theme', 'tips/404', 'tips/error'];

  if (layui.setter.runServeType === 'devServe' || layui.setter.runServeType === 'testServe') {
    var demo = ['demo/component/index', 'demo/component/echart', 'demo/component/auth', 'demo/component/daterange', 'demo/component/eleTree', 'demo/component/company', 'component/icon/index'];
