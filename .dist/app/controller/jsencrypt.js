...
layui.define(function (exports) {
  exports('jsencrypt', function (message) {
    ...
    var des = function des(key, message, encrypt, mode, iv) {
    ...
    var des_createKeys = function des_createKeys(key) {
    ...
    var stringToHex = function stringToHex(s) {
      var r = "";
    ...
    var HexTostring = function HexTostring(s) {
      var r = "";
