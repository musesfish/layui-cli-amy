...
layui.define(function (exports) {
  ...
  function verifyDataInit(d, dt) {
    if (_typeof(d) === 'object' && !Array.isArray(d)) {
      for (var i in d) {
        if (_typeof(d[i]) === 'object' && !Array.isArray(d[i]) && d[i] != null) {
  ...
  function verifyDataTypes($d, $dt) {
    ...
    switch (dt) {
      ...
      case 'date':
        d = convertTime(d, 'date');
        break;

      case 'month':
        d = convertTime(d, 'month');
        break;

      case 'time':
        d = convertTime(d, 'time');
        break;
  ...
  function convertTime(d, format) {
    ...
    switch (format) {
      case 'YMD':
        t = "".concat(t.getFullYear(), "-").concat(layui.api.markZero(t.getMonth() + 1, 2), "-").concat(layui.api.markZero(t.getDate(), 2));
        break;

      case 'date':
        t = "".concat(t.getFullYear(), "-").concat(layui.api.markZero(t.getMonth() + 1, 2), "-").concat(layui.api.markZero(t.getDate(), 2), " ").concat(layui.api.markZero(t.getHours(), 2), ":").concat(layui.api.markZero(t.getMinutes(), 2), ":").concat(layui.api.markZero(t.getSeconds(), 2));
        break;

      case 'month':
        t = "".concat(t.getFullYear(), "-").concat(layui.api.markZero(t.getMonth() + 1, 2));
        break;

      case 'time':
        t = "".concat(layui.api.markZero(t.getHours(), 2), ":").concat(layui.api.markZero(t.getMinutes(), 2), ":").concat(layui.api.markZero(t.getSeconds(), 2));
        break;
  ...
  function getTimeYMDHM(str) {
    var result = str.match(/\d{4}-\d{1,2}-\d{1,2}.?\d{1,2}:\d{1,2}/);
  ...
  function getChinaData(type, arr) {
    var dataMap = [{
      name: '江西',
      value: '200',
      map: [115.892151, 28.676493]
    }, {
      name: '四川',
      value: '200',
      map: [104.065735, 30.659462]
    }, {
      name: '西藏',
      value: '200',
      map: [91.132212, 29.660361]
    }, {
      name: '贵州',
      value: '200',
      map: [106.713478, 26.578343]
    }, {
      name: '辽宁',
      value: '200',
      map: [123.429096, 41.796767]
    }, {
      name: '新疆',
      value: '200',
      map: [87.617733, 43.792818]
    }, {
      name: '山东',
      value: '200',
      map: [117.000923, 36.675807]
    }, {
      name: '澳门',
      value: '200',
      map: [113.54909, 22.198951]
    }, {
      name: '山西',
      value: '200',
      map: [112.549248, 37.857014]
    }, {
      name: '海南',
      value: '200',
      map: [110.33119, 20.031971]
    }, {
      name: '福建',
      value: '200',
      map: [119.306239, 26.075302]
    }, {
      name: '青海',
      value: '200',
      map: [101.778916, 36.623178]
    }, {
      name: '宁夏',
      value: '200',
      map: [106.278179, 38.46637]
    }, {
      name: '甘肃',
      value: '200',
      map: [103.823557, 36.058039]
    }, {
      name: '安徽',
      value: '200',
      map: [117.283042, 31.86119]
    }, {
      name: '台湾',
      value: '200',
      map: [121.509062, 25.044332]
    }, {
      name: '陕西',
      value: '200',
      map: [108.948024, 34.263161]
    }, {
      name: '广西',
      value: '200',
      map: [108.320004, 22.82402]
    }, {
      name: '天津',
      value: '200',
      map: [117.190182, 39.125596]
    }, {
      name: '云南',
      value: '200',
      map: [102.712251, 25.040609]
    }, {
      name: '黑龙江',
      value: '200',
      map: [126.642464, 45.756967]
    }, {
      name: '河北',
      value: '200',
      map: [114.502461, 38.045474]
    }, {
      name: '内蒙古',
      value: '200',
      map: [111.670801, 40.818311]
    }, {
      name: '吉林',
      value: '200',
      map: [125.3245, 43.886841]
    }, {
      name: '江苏',
      value: '200',
      map: [118.767413, 32.041544]
    }, {
      name: '香港',
      value: '200',
      map: [114.173355, 22.320048]
    }, // 以下为 现有分公司所在省份
    {
      name: '北京',
      value: '200',
      map: [116.405285, 39.904989]
    }, {
      name: '河南',
      value: '200',
      map: [113.665412, 34.757975]
    }, {
      name: '湖北',
      value: '200',
      map: [114.298572, 30.584355]
    }, {
      name: '上海',
      value: '200',
      map: [121.472644, 31.231706]
    }, {
      name: '浙江',
      value: '200',
      map: [120.153576, 30.287459]
    }, {
      name: '湖南',
      value: '200',
      map: [112.982279, 28.19409]
    }, {
      name: '重庆',
      value: '200',
      map: [106.504962, 29.533155]
    }, {
      name: '广东',
      value: '200',
      map: [113.280637, 23.125178]
    }];

    if (type == 1) {
      //前三名高亮 其他分点常亮
      for (var _i = 0; _i < dataMap.length; _i++) {
        for (var _j = 0; _j < arr.length; _j++) {
          if (arr[_j].province == dataMap[_i].name && _j <= 2) {
            dataMap[_i].value = '600';
          } else if (arr[_j].province == dataMap[_i].name) {
            dataMap[_i].value = '250';
          }
        }
      }
      ...
      for (var i = 0; i < dataMap.length; i++) {
        var _obj = {};
        _obj.label = dataMap[i].name;
        _obj.value = dataMap[i].name;
  ...
  function exportXLSX(_ref) {
    var _ref$count = _ref.count,
        count = _ref$count === void 0 ? 999 : _ref$count,
        url = _ref.url,
        where = _ref.where,
        _ref$cols = _ref.cols,
        cols = _ref$cols === void 0 ? [] : _ref$cols,
        _ref$filename = _ref.filename,
        filename = _ref$filename === void 0 ? "未命名" : _ref$filename,
        handleDataList = _ref.handleDataList,
        beforeFunc = _ref.beforeFunc;
    var XLSX = layui.XLSX;
    if (!XLSX) return false;
    var cols_title = cols.map(function (i) {
      return i.title;
    });
    var datalist = null;
    layui.ajax({
    ...
    var list = [cols_title].concat(_toConsumableArray(datalist.map(function (item, index) {
      return _toConsumableArray(cols.map(function (i) {
        if (i.type === 'numbers') return index + 1;

        if (i.templet) {
          if (typeof i.templet === 'function') return i.templet(item);else return i.templet;
        }
    ...
    var ws = XLSX.utils.aoa_to_sheet(list, options);
    ws['!cols'] = cols.map(function (i) {
      return {
        wpx: i.width || 100
      };
    });
    ...
    XLSX.writeFileSync(wb, "".concat(filename, ".xlsx"));
  }
  ...
  function getTableTagProcessStatus(d) {
    var s = _typeof(d) !== 'object' ? d : d === null || d === void 0 ? void 0 : d.approvalState;
    if (!s && s !== 0) return false;
    return "<span class=\"tag-process-status\" data-status=\"".concat(s, "\"></span>");
  }
