; layui.define([
    ...
    function init(v, func){ 
        v.on('click', '.j-sel-personnel', function () {
            ...
            typeof all === 'undefined'? '':query.push('all=1');
            // typeof roleId === 'unedefined'? '': query.push('r='+roleId);
            ...
            bindEvent(conUrl, {
                yes: function (index, dom) {
                    if (typeof func === 'object' && func.hasOwnProperty('callback')) {
                        ...
                        if (typeof input === 'object') input.val(data.join(","));
