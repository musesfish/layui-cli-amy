...
;layui.define("view", function (e) {
        ...
        var i = e.path, t = function (e) {
            ...
            e.each(function (e, l) {
                ...
                if (u.each(function (e, l) {
                        // 兼容二级路由带参
                        var name = location.hash.replace(/(#\/.*?\/)|(\/$)/g,'');
                        var r = a(l), u = t(r), d = u.list.children("dd"),
                        y = i[0] == o.name && name == u.name || u.jump && n == x.correctRouter(u.jump);
                        if (d.each(function (e, l) {
                                var r = a(l), d = t(r),
                                    y = i[0] == o.name && i[1] == u.name && ( i[2] == d.name || ( i[2] === '' && d.name === 'index' )) || d.jump && n == x.correctRouter(d.jump);
                                if (y) {
                                    var m = d.list[0] ? s : c;
                            ...
                            var m = u.list[0] ? s : c; 
                            r.addClass(m).siblings().removeClass(m);
                            return !1
                        }
                    }), d) {
                    var y = o.list[0] ? s : c;
    ...
    var k = function (e) {
        ...
        // 保存layui router 的参数 
        var a = e.attr("lay-attr"), i = e.index(); 
