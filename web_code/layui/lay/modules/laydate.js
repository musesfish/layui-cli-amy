...
! function () {
    ...
    f.prototype = [], f.prototype.constructor = f, y.extend = function () {
        ...
        ], s.list(l.type, 0).list(l.type, 1), "time" === l.type ? s.setBtnStatus("时间", y.extend({}, s.systemDate(), s.startTime), y.extend({}, s.systemDate(), s.endTime)) : s.setBtnStatus(!0))), l.range || (s.listYM = [
            [d.year, d.month + 1]
        ...
        }), y(f[v ? 0 : 1]).attr("lay-ym", T[0] + "-" + T[1]).html(T[0] + D);
        else if ("time" === e) {
            var b = function () {
        ...
        if (g && p.removeChild(g), p.appendChild(c), "year" === e || "month" === e) y(n.elemMain[t]).addClass("laydate-ym-show"), y(c).find("li").on("click", function () {
            ...
            if (!y(this).hasClass(i)) {
                if (0 === t) o[e] = s, d && (n.startDate[e] = s), n.limit(y(n.footer).find(m), null, 0);
                else if (d) n.endDate[e] = s;
                else {
        ...
        if (s = {
            ...
            if (n.range) {
                ...
                }), t.endState) l(), delete t.endState, delete t.endDate, t.startState = !0, o.removeClass(a + " " + d), e.addClass(a);
            ...
            l = {
                datetime: function () {
                    ...
                    if (n.startDate) {
                        ...
                        var val = `${n.startDate.year}-${n.startDate.month + 1}-${n.startDate.date} - 9999-12-31`;
        ...
        var t = this,
            ...
            s = function (s) {
                ...
                return d && (o[0] = s ? o[0] - 15 : o[0] + 15, t.list("year", e)), c && (s ? o[0]-- : o[0]++ , t.list("month", e)), (d || c) && (y.extend(a, {
                    year: o[0]
        ...
        e.trigger === 'click' && (elem.on('focus', function(){ elem.blur()}));
        var t = new h(e);
        return function () {
            var e = this;
            return {
