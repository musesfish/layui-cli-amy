 ...
 */
     ...
     function l() {
         ...
         this.retrieve_tag = function(t) {
             if (this.tags[t + "count"]) {
                 for (var e = this.tags.parent; e && t + this.tags[t + "count"] !== e; )
         ...
         this.get_tag = function() {
             ...
             do {
                 ...
                 this.pos++,
                 this.line_char_count++,
                 this.Utils.in_array(t, this.Utils.whitespace) ? (i = !0,
                 this.line_char_count--) : ("'" !== t && '"' !== t || e[1] && "!" === e[1] || (t += this.get_unformatted(t),
                 i = !0),
                 "=" === t && (i = !1),
                 e.length && "=" !== e[e.length - 1] && ">" !== t && i && (this.line_char_count >= this.max_char ? (this.print_newline(!1, e),
                 this.line_char_count = 0) : (e.push(" "),
                 this.line_char_count++),
                 i = !1),
                 e.push(t))
             } while (">" !== t);var n, l = e.join("");
             n = -1 !== l.indexOf(" ") ? l.indexOf(" ") : l.indexOf(">");
             var a = l.substring(1, n).toLowerCase();
             if ("/" === l.charAt(l.length - 2) || this.Utils.in_array(a, this.Utils.single_token))
                 ...
                 "/" === a.charAt(0) ? (this.retrieve_tag(a.substring(1)),
                 this.tag_type = "END") : (this.record_tag(a),
                 this.tag_type = "START"),
         ...
         this.get_token = function() {
             ...
             if ("TK_TAG_SCRIPT" === this.last_token) {
                 ...
                 return "string" != typeof e ? e : (t = js_beautify(e, this.indent_size, this.indent_character, this.indent_level),
                 [t, "TK_CONTENT"])
             }
             ...
             if ("TAG" === this.current_mode) {
                 if ("string" != typeof (t = this.get_tag()))
                     return t;
         ...
         this.printer = function(t, e, i, n) {
             ...
             this.max_char = n || 7e3,
             this.line_char_count = 0;
             for (var l = 0; l < this.indent_size; l++)
                 this.indent_string += this.indent_character;
             this.print_newline = function(t, e) {
                 if (this.line_char_count = 0,
                 e && e.length) {
                     if (!t)
                         for (; this.Utils.in_array(e[e.length - 1], this.Utils.whitespace); )
                             e.pop();
                     e.push("\n");
 ...
 function js_beautify(t, e, i, n) {
     function l() {
         for (; h.length && (" " === h[h.length - 1] || h[h.length - 1] === E); )
             h.pop()
     }
     function a(t) {
         if (t = void 0 === t || t,
     ...
     function p() {
         ...
         if (f(e, k)) {
             if (A < m.length)
                 for (; f(m.charAt(A), k) && (e += m.charAt(A),
                 (A += 1) !== m.length); )
                     ;
         ...
         if ("/" === e) {
             ...
             if ("*" === m.charAt(A)) {
                 if ((A += 1) < m.length)
                     for (; ("*" !== m.charAt(A) || !m.charAt(A + 1) || "/" !== m.charAt(A + 1)) && A < m.length && (l += m.charAt(A),
                     !((A += 1) >= m.length)); )
                         ;
                 return A += 2,
                 ["/*" + l + "*/", "TK_BLOCK_COMMENT"]
         ...
         if ("'" === e || '"' === e || "/" === e && ("TK_WORD" === g && "return" === v || "TK_START_EXPR" === g || "TK_END_BLOCK" === g || "TK_OPERATOR" === g || "TK_EOF" === g || "TK_END_COMMAND" === g)) {
             ...
             if (e = "",
             A < m.length)
                 for (; (s || m.charAt(A) !== o) && (e += m.charAt(A),
                 s = !s && "\\" === m.charAt(A),
                 !((A += 1) >= m.length)); )
                     ;
             return A += 1,
         ...
         if (f(e, w)) {
             for (; A < m.length && f(e + m.charAt(A), w) && (e += m.charAt(A),
             !((A += 1) >= m.length)); )
                 ;
     ...
     N = !1; ; ) {
         ...
         case "TK_WORD":
             ...
             O = "NONE",
             "TK_END_BLOCK" === g ? f(y.toLowerCase(), ["else", "catch", "finally"]) ? (O = "SPACE",
             o()) : O = "NEWLINE" : "TK_END_COMMAND" !== g || "BLOCK" !== b && "DO_BLOCK" !== b ? "TK_END_COMMAND" === g && "EXPRESSION" === b ? O = "SPACE" : "TK_WORD" === g ? O = "SPACE" : "TK_START_BLOCK" === g ? O = "NEWLINE" : "TK_END_EXPR" === g && (o(),
             O = "NEWLINE") : O = "NEWLINE",
         ...
         case "TK_OPERATOR":
             ...
             "--" === y || "++" === y ? ";" === v ? (P = !0,
             R = !1) : (P = !1,
             R = !1) : "!" === y && "TK_START_EXPR" === g ? (P = !1,
             R = !1) : "TK_OPERATOR" === g ? (P = !1,
             R = !1) : "TK_END_EXPR" === g ? (P = !0,
             R = !0) : "." === y ? (P = !1,
             R = !1) : ":" === y && (P = !!v.match(/^\d+$/)),
             P && o(),
             s(),
 ...
 layui.define(["layer", "form", "code"], function(t) {
     ...
     s.prototype.build = function(t, e) {
         ...
         return a.ie && a.ie < 8 ? s.removeClass("layui-hide").addClass("layui-show") : (u[0] && u.remove(),
         r.call(n, m, s[0], f),
         s.addClass("layui-hide").after(m),
         layui.use(["colorpicker", "jquery"], function() {
             for (var t = layui.colorpicker, e = (layui.jquery,
             0); e <= n.index; e++)
                 t.render({
                     elem: "#layBkColor_" + e,
                     predefine: !0,
     ...
     s.prototype.getContent = function(t) {
         var e = d(t);
         if (e[0])
             return c(e[0].document.body.innerHTML)
     }
     ,
     s.prototype.getText = function(t) {
         var e = d(t);
         if (e[0])
             return i(e[0].document.body).text()
     }
     ,
     s.prototype.setContent = function(t, e, n) {
         var l = d(t);
         l[0] && (n ? i(l[0].document.body).append(e) : i(l[0].document.body).html(e),
         this.sync(t))
     }
     ,
     ...
     var r = function(t, e, n) {
       ...
       , u = function(t, e, l, o) {
         ...
         r.on("keydown", function(t) {
             ...
             if (8 === e) {
                 var d = p(s)
                   , c = m(d);
                 if ("<hr>" == c.innerHTML && "BODY" == c.tagName && (d.selectNode(c.childNodes[0]),
                 d.deleteContents()),
                 c.hasChildNodes() && "IMG" == c.childNodes[0].tagName) {
                     var f = o.calldel;
                 ...
                 for (var c = 0, u = e.originalEvent.clipboardData.items.length; c < u; c++) {
                     ...
                     if ("file" === h.kind) {
                         ...
                         if (i.ajax({
                             ...
                             success: function(t) {
                                 // 0 != t.code && 2 != t.code || (x = t.data.src,
                                 0 != t.code && 2 != t.code || (x = t.files[0].saveUrl,
                                 o.uploadImage.done(t))
                             },
                             error: function(t) {
                                 n.msg("上传服务器出错")
                             }
       ...
       , h = function(t, e, i) {
         ...
         a.ie) {
             ...
             var d = m(i);
             d.parentNode;
             "<br>" == d.innerHTML && (i.selectNode(d),
             i.deleteContents()),
             i.deleteContents(),
             i.insertNode(o),
             "img" == t && "<br>" == d.innerHTML && (l.execCommand("formatBlock", !1, "<p>"),
             l.execCommand("justifyCenter"),
             setTimeout(function() {
                 body.focus()
             }, 10))
         }
       ...
       , y = function(t, e) {
         ...
         i(a).parents().each(function() {
             ...
             "a" === t && (s("link").addClass(l),
             s("unlink").removeClass(o))
         })
     }
       , g = function(t, e, l) {
         var a = t.document
           ...
           , r = {
                 ...
                 layui.use("upload", function(o) {
                     ...
                     o.render({
                         ...
                         elem: i(a).find("input")[0],
                             ...
                             h.call(t, "img", {
                                 // src: i.data.src,
                                 src: i.files[0] && i.files[0].visitUrl,
                                 // alt: i.data.title
                                 alt: i.files[0] && i.files[0].orgName
                             }, e),
                             r.done(i),
                             setTimeout(function() {
                                 s.focus()
             ...
             images: function(e) {
                 ...
                 n.open({
                     ...
                     yes: function(i, l) {
                         ...
                         0 === l.find("#imgsPrev").find("img").length ? n.msg("请选择要插入的图片") : ("" != a && (a = "style='" + a + "'"),
                         h.call(t, "p", {
                     ...
                     btn2: function(t, e) {
                         if (e.find("#imgsPrev img").length > 0) {
                             for (var n = "", a = 0; a < e.find("#imgsPrev img").length; a++)
                                 n += e.find("#imgsPrev img")[a].src;
                             var o = l.calldel;
                             "" != o.url && i.post(o.url, {
                                 imgpath: n
                             }, function(t) {
                             ...
                             e.render({
                                 ...
                                 before: function(t) {
                                     ...
                                     t.preview(function(t, e, n) {
                                         ...
                                         -1 === s.indexOf(t) && i("#imgsPrev").append('<img data-index="' + t + '" src="' + n + '" alt="' + e.orgName + '" style="max-width:70px;margin:2px" /> ')
                                     })
                                 },
                                 allDone: function() {
                                     for (var t = 0; t < s.length; t++)
                                         i("#imgsPrev").find('img[data-index="' + s[t] + '"]').remove();
                                     n.close(o)
                                 },
                                 error: function(t, e) {
                                     s.push(t)
                                     ...
                                     // i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src),
                                     i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.files[0].visitUrl),
                                     a.done(e)) : 2 == e.code ? (e.data = e.data || {},
                                     // i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src),
                                     i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.files[0].visitUrl),
                                     a.done(e)) : n.msg(e.msg || "上传失败"),
                                     t.find("#imgsPrev img").on("click", function() {
                                         var t = this.src
                 ...
                 n.open({
                     ...
                     success: function(t, e) {
                         layui.use("upload", function(e) {
                             var i, e = layui.upload, a = t.find('input[name="altStr"]'), o = t.find('input[name="Imgsrc"]'), s = l.uploadImage || {};
                             ...
                             e.render({
                                 ...
                                 before: function(t) {
                                     ...
                                     100 == t.ret)
                                         // t.data = t.data || {},
                                         // o.val(t.data.src),
                                         o.val(t.files[0] && t.files[0].visitUrl),
                                         // a.val(t.data.name),
                                         a.val(t.files[0].orgName),
                                         s.done(t);
                                     // else if (2 == t.code)
                                     else if (100 == t.ret)
                                         var r = n.open({
                                             ...
                                             content: t.msg + "<div style='text-align:center;'><img src='" + t.files[0].visitUrl + "' style='max-height:80px'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
                                             btn: ["确定", "取消"],
                                             yes: function() {
                                                 // t.data = t.data || {},
                                                 // o.val(t.data.src),
             ...
             video: function(e) {
                 ...
                 n.open({
                     ...
                     success: function(t, e) {
                         layui.use("upload", function(e) {
                             var i, o = t.find('input[name="video"]'), s = t.find('input[name="cover"]'), e = layui.upload, r = l.uploadImage || {};
                             ...
                             e.render({
                                 ...
                                 before: function(t) {
                                     ...
                                     // 0 == t.code)
                                         // t.data = t.data || {},
                                         // s.val(t.data.src),
                                         s.val(t.files[0] && t.files[0].visitUrl),
                                         r.done(t);
                                     // else if (2 == t.code)
                                     else if (100 == t.ret)
                                         var a = n.open({
                                             ...
                                             content: t.msg + "<div><img src='" + t.files[0].visitUrl + "' style='max-height:100px'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
                                             btn: ["确定", "取消"],
                                             yes: function() {
                                                 // t.data = t.data || {},
                                                 // s.val(t.data.src),
                                 ...
                                 before: function(t) {
                                     ...
                                     // else if (2 == t.code)
                                         var a = n.open({
                                             ...
                                             content: t.msg + "<div><video src='" + t.files[0].visitUrl + "' style='max-height:100px' controls='controls'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
                                             btn: ["确定", "取消"],
                                             yes: function() {
                                                 // t.data = t.data || {},
                                                 // o.val(t.data.src),
                     ...
                     success: function(a, o) {
                         layui.use("upload", function() {
                             ...
                             s.render({
                                 ...
                                 before: function(t) {
                                     t.preview(function(t, e, n) {
                                         -1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.orgName + '" >' + e.orgName + "</a>&nbsp;")
                                         // -1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.name + '" >' + e.name + "</a>&nbsp;")
                                     })
                                 },
                                 allDone: function() {
                                     for (var l = 0; l < d.length; l++)
                                         i("#filesPrev").find('a[data-index="' + d[l] + '"]').remove();
                                 ...
                                 error: function(t, e) {
                                     ...
                                     100 == t.ret ? (
                                     // t.data = t.data || {},
                                     // i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src),
                                     i('#filesPrev a[data-index="' + e + '"]').attr("href", t.files[0] && t.files[0].visitUrl),
                                     // r.done(t)) : 2 == t.code ? (n.msg(t.msg || "上传失败"),
                                     r.done(t)) : 100 == t.ret ? (n.msg(t.msg || "上传失败"),
                                     // t.data = t.data || {},
                                     // i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src),
                                     i('#filesPrev a[data-index="' + e + '"]').attr("href", t.files[0] && t.files[0].visitUrl),
                                     r.done(t)) : n.msg(t.msg || "上传失败"),
                                     a.find("#filesPrev a").on("click", function() {
             ...
             fullScreen: function(t) {
                 null == this.parentElement.parentElement.getAttribute("style") ? (this.parentElement.parentElement.setAttribute("style", "position: fixed;top: 0;left: 0;height: 100%;width: 100%;background-color: #fff;z-index: 9999;"),
                 ...
                 this.parentElement.nextElementSibling.lastElementChild.id.indexOf("aceHtmleditor") > -1 && (this.parentElement.nextElementSibling.firstElementChild.style = "position: absolute;left: -32768px;top: -32768px;",
                 this.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height: " + (this.parentElement.parentElement.offsetHeight - this.parentElement.offsetHeight) + "px"))) : (this.parentElement.parentElement.removeAttribute("style"),
                 ...
                 this.parentElement.nextElementSibling.lastElementChild.id.indexOf("aceHtmleditor") > -1 && (this.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height:" + this.parentElement.nextElementSibling.firstElementChild.clientHeight + "px"),
             ...
             customlink: function(e) {
                 ...
                 x.call(s, {
                     ...
                     var n = a[0];
                     "A" === n.tagName ? (n.href = i.url,
                     n.rel = i.rel) : h.call(t, "a", {
                         target: "_blank",
             ...
             table: function(e) {
                 _.call(this, {}, function(i) {
                     for (var n = "<tr>", l = 0; l < i.cells; l++)
                         n += "<td></td>";
                     n += "</tr>";
                     for (var a = n, l = 0; l < i.rows; l++)
                         n += a;
                     h.call(t, "table", {
                         text: n
                     }, e)
           ...
           , c = function() {
             ...
             if (!e.hasClass(o)) {
                 ...
                 l ? (/justifyLeft|justifyCenter|justifyRight/.test(l) && "BODY" === u.parentNode.tagName && a.execCommand("formatBlock", !1, "<p>"),
                 a.execCommand(l),
                 setTimeout(function() {
                     if (/Bold/.test(l)) {
         ...
         var f = null
           , g = function(t) {
             ...
             if (null != t && "default" != e.type) {
                 ...
                 o = a.parentNode,
                 "custom" == e.type)
                     return e.customEvent(a.tagName, t),
                     !1;
                 switch (a.tagName) {
                     case "IMG":
                     console.log('smy1');
                     f = n.open({
                         ...
                         yes: function(e, i) {
                             ...
                             "" == l ? n.msg("请选择一张图片或输入图片地址") : (t.target.src = l,
                             t.target.alt = i.find('input[name="altStr"]').val(),
                             t.target.style.width = "" != a ? a.indexOf("%") > 0 ? a : a + "px" : "",
                             t.target.style.height = "" != o ? o.indexOf("%") > 0 ? o : o + "px" : "",
                             n.close(e))
                         },
                         btn2: function(t, e) {},
                         btn3: function(e, a) {
                 ...
                 case "VIDEO":
                     ...
                     f = n.open({
                         ...
                         yes: function(e, i) {
                             ...
                             "" == l.val() ? n.msg("请选择一个视频或输入视频地址") : (t.target.src = l.val(),
                             t.target.poster = a.val(),
                             n.close(e))
                         },
                         btn2: function(t, e) {},
                         btn3: function(e, a) {
                         ...
                         success: function(t, e) {
                             layui.use("upload", function(e) {
                                 var i, a = t.find('input[name="video"]'), o = t.find('input[name="cover"]'), e = layui.upload, r = l.uploadImage || {}, d = l.uploadVideo || {};
                                 "" == r.url && n.msg("图片上传接口配置错误！"),
                                 "" == d.url && n.msg("视频上传接口配置错误！"),
                                 e.render({
                                     elem: "#LayEdit_InsertImage",
                                 ...
                                 e.render({
                                     ...
                                     before: function(t) {
                                         ...
                                         100 == t.ret)
                                             // t.data = t.data || {},
                                             // a.val(t.data.src),
                                             a.val(t.files[0] && t.files[0].visitUrl),
                                             d.done(t);
                                         // else if (2 == t.code)
                                         else if (100 == t.ret)
                                             var o = n.open({
                             ...
                             t.find("li").on("click", function() {
                                 ...
                                 if (l)
                                     ...
                                     case "deltr":
                                         ...
                                         break;
                                     case "addnewtr":
                                         for (var a = "<tr>", s = 0; s < o.children.length; s++)
                                             a += "<td></td>";
                                         a += "</tr>",
                                         i(o).after(a)
                                     }
                 ...
                 t.find("td").on("touchmove", function(n) {
                     ...
                     if (null != l && "TD" === l.tagName.toUpperCase()) {
                         ...
                         for (var a = 0; a < i(l.parentElement).prevAll().length; a++)
                             for (var o = 0; o < i(l.parentElement).prevAll()[a].childNodes.length; o++)
                                 o <= l.cellIndex && (i(l.parentElement).prevAll()[a].children[o].style = "background-color:linen;")
                     }
                 }),
             ...
             success: function(e, l) {
                 e.find("td").on("mouseover", function() {
                     ...
                     for (var t = 0; t < i(this.parentElement).prevAll().length; t++)
                         for (var n = 0; n < i(this.parentElement).prevAll()[t].childNodes.length; n++)
                             n <= this.cellIndex && (i(this.parentElement).prevAll()[t].children[n].style = "background-color:linen;")
                 }),
       ...
       , C = {
         ...
         image: '<i class="layui-icon layedit-tool-image" title="图片" layedit-event="image" style="font-size:18px">&#xe64a;<input type="file" name="file1"></i>',
