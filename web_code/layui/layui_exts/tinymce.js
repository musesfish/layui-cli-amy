...
layui.define(['jquery'],function (exports) {
    ...
    var settings = {
        base_url: modPath
        , images_upload_url: layui.api.getUploadPath() //图片上传接口，可在option传入，也可在这里修改，option的值优先
    ...
    function initOptions(option,callback) {
        ...
        option.plugins = isset(option.plugins) ? option.plugins : 'code quickbars print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists imagetools indent2em';
